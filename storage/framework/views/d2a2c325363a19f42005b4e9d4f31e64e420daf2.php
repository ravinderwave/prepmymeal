<?php $__env->startSection('title','My Account || PrepMyMeal'); ?>
				    ...
				    <div class="col-md-12 col-sm-12 col-xs-12">
						<div class="col-xs-12 col-sm-3 col-md-3">
				            <ul class="nav nav-tabs tabs-left">
				                <li class="active"><a href="<?php echo e(route('customer.dashboard')); ?>"> <strong>My Profile</strong></a></li>
				                <li><a href="<?php echo e(route('customer.addresses')); ?>"> Manage Addresses</a></li>
				                ...
				                <div class="tab-pane active" id="profile">
									<div class="row">
										...
										<div class="col-md-12 col-xs-12 col-sm-12">
											<?php echo Form::open(['route'=>'customer.updateProfile','autocomplete'=>'new1-password']); ?>

												<div class="form-group col-md-6">
													<label>Fullname</label>
													<input type="text" class="form-control" placeholder="Enter Fullname" value="<?php echo e($customer->name); ?>" name="name" />
													<small class="text text-danger"><?php echo e($errors->first('name')); ?></small>
												</div>
												<div class="form-group col-md-6">
													<label>Username</label>
													<input type="text" class="form-control" placeholder="Enter Username" value="<?php echo e($customer->username); ?>" name="username" />
													<small class="text text-danger"><?php echo e($errors->first('username')); ?></small>
												</div>
												<div class="form-group col-md-6">
													<label>Email</label>
													<input type="email" class="form-control" placeholder="Enter Email" value="<?php echo e($customer->email); ?>" name="email" readonly="readonly" />
													<small class="text text-danger"><?php echo e($errors->first('email')); ?></small>
												</div>
												<div class="form-group col-md-6">
													<label>Phone</label>
													<input type="text" class="form-control" placeholder="Enter Phone" value="<?php echo e($customer->phone); ?>" name="phone"/>
										...
										<div class="col-md-12 col-xs-12 col-sm-12">
											<?php echo Form::open(['route'=>'customer.updatePassword','autocomplete'=>'new-password']); ?>

												<div class="form-group col-md-6">
													<label>Old Password</label>
													<input type="password" class="form-control" placeholder="Enter Old Password" value="" name="oldPassword"/>
													<small class="text text-danger"><?php echo e($errors->first('oldPassword')); ?></small>
												</div>
												<div class="form-group col-md-6">
