                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="col-xs-12 col-sm-3 col-md-3">
                        <ul class="nav nav-tabs tabs-left">
                            ...
                            <li class="active"><a href="<?php echo e(route('customer.addresses')); ?>"> <strong>Manage Addresses</strong></a></li>
                                        ...
                                        <?php if(count($addresses)): ?>
                                            <?php $__currentLoopData = $addresses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $address): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="form-group">
                                                    <div><?php echo e($address->address); ?>,<?php echo e($address->city); ?>,<?php echo e($address->state); ?>,<?php echo e($address->zip); ?>

                                                        <button class="btn btn-xs btnSubmit btnEditView" data-id="<?php echo e($address->id); ?>"><i
