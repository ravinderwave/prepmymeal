<?php $__env->startSection('title','Checkout || PrepMyMeal'); ?>
...
<style>
    ...
    <section class="">
        <div class="item ">
            <img src="<?php echo e(asset('assets/frontend/img/13.jpg')); ?>" alt="Los Angeles" style="width:100%;">
        </div>
    </section>
    <section class="main-three  main-space">
        <div class="container">
            <div class="row">
                <form action="<?php echo e(route('payment.do')); ?>" method="POST" id="billing_address payment-form" class="require-validation" data-cc-on-file="false" data-stripe-publishable-key="<?php echo e(env('STRIPE_KEY')); ?>">
                    ...
                    <div class="col-md-10 col-md-offset-1">
                        ...
                        <div class="profile-usertitle" style="border: solid #dddddd  1px; padding-left: 5px">
                            <div class="profile-usertitle-name">
                                ...
                                <?php echo e(ucwords(Auth::guard('customer')->user()->username)); ?>
                                ...
                                <a target="_blank" href="<?php echo e(route('customer.login')); ?>">Login</a> or check out as guest
                    ...
                    <div class="col-md-10 col-md-offset-1">
                            ...
                            <ul class="list-group mb-3 " id="myaddressList">
                                ...
                                <li class="list-group-item d-flex justify-content-between lh-condensed">
                                    <div class="checked-address">
                                        <input id="address_<?php echo e($address->id); ?>" type="radio" name="address_id" value="<?php echo e($address->id); ?>">
                                    </div>
                                    <div class="checked-address">
                                        <label for="address_<?php echo e($address->id); ?>"><i class="glyphicon glyphicon-home"></i>
                                            <?php
                                    ...
                                    <span class="btn btn-xs btnSubmit btnEditView btn-success editAddButton" data-id="<?php echo e($address->id); ?>"><i
                        ...
                        <div id="new_address">
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    ...
                                    <input name="firstName" type="text" class="form-control" id="firstName" placeholder="" value="" <?php echo e($required); ?>>
                                </div>
                                <div class="col-md-6 form-group">
                                    <label for="email">Email </label>
                                    <input name="email" type="email" class="form-control" id="email" placeholder=" " <?php echo e($required); ?>></div>
                            </div>

                            <div class="row">
                                <div class="col-md-6 form-group">
                                    <label for="address">Address</label>
                                    <input type="text" name="address" class="form-control" id="address" placeholder=" " <?php echo e($required); ?>>
                            ...
                            <div class="row">
                                <div class="col-md-5 mb-3">
                                    ...
                                    <select name="country" class="custom-select d-block w-100 form-control" id="country" <?php echo e($required); ?>>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select class="custom-select d-block w-100 form-control" name="state" id="state" <?php echo e($required); ?>>
                                        <option value="">Choose...</option>
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input name="zip" type="text" class="form-control" id="zip" placeholder="" <?php echo e($required); ?>>
                        ...
                        <div class="">
                            ...
                            <input id="delivery" type="radio" name="delivery" value=""> <label class="custom-control-label" for="delivery">
                                Di. <?php echo e($tuesday); ?> (09-12 Uhr) € <?php echo e($siteOptions->shipping_tax); ?></label>
                        </div>
                        <div class=" ">
                            <input id="delivery1" type="radio" name="delivery" value=""> <label class="custom-control-label" for="delivery1">
                                Mi. <?php echo e($wednesday); ?> (09-12 Uhr) € <?php echo e($siteOptions->shipping_tax); ?></label>
                        </div>
                        <div class="">
                            <input id="delivery2" type="radio" name="delivery" value=""> <label class="custom-control-label" for="delivery2">
                                Do. <?php echo e($thursday); ?> (09-12 Uhr) €<?php echo e($siteOptions->shipping_tax); ?></label>
                        </div>
                        <hr class="mb-4">
                        ...
                        <div class="modal-dialog modal-md">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <?php echo $__env->make('frontend.stripe_recurring', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                </div>
                    ...
                    <div class="modal fade" id="addAddress" role="dialog" data-backdrop="static" data-keyboard="false">
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <?php echo Form::open(['route'=>'customer.addAddress','autocomplete'=>'new1-password']); ?>

                                    <input type="hidden" id="addressID" value="">
                                    <div class="form-group col-md-6">
                                        <label>Address</label>
                                        <input type="text" class="form-control" placeholder="Enter Address" value="<?php echo e(old('address')); ?>" id="addressNew"/>
                                        <small class="text text-danger"><?php echo e($errors->first('address')); ?></small>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>City</label>
                                        <input type="text" class="form-control" placeholder="Enter City" value="<?php echo e(old('city')); ?>" id="cityNew"/>
                                        <small class="text text-danger"><?php echo e($errors->first('city')); ?></small>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>State</label>
                                        <input type="text" class="form-control" placeholder="Enter State" value="<?php echo e(old('state')); ?>" id="stateNew"/>
                                        <small class="text text-danger"><?php echo e($errors->first('state')); ?></small>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>Zip</label>
                                        <input type="text" class="form-control" placeholder="Enter Zip" value="<?php echo e(old('zip')); ?>" id="zipNew"/>
                                        <small class="text text-danger"><?php echo e($errors->first('zip')); ?></small>
                                    </div>
                                    <?php echo Form::close(); ?>
    ...
    <script>
        ...
        $('.btnEditView').on('click', function () {
            ...
            console.log(id)
            $.ajax({
                url: "<?php echo e(route('customer.singleAddress')); ?>",
                method: "get",
                data: {id: id},
        ...
        $('.btnSave').on('click', function () {
            ...
            var dataString = {address: address, city: city, state: state, zip: zip, '_token': '<?php echo e(csrf_token()); ?>'}
            if (id != '') {
                dataString.id = id;
            }
            $.ajax({
                url: "<?php echo e(route('customer.addAddress')); ?>",
                method: "post",
                data: dataString,
                success: function (response) {
