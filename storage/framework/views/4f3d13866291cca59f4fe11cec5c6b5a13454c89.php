...
<div style="width: 80%">
    ...
    <table style="width:100%;  border: 1px solid black;border-collapse: collapse;">
        ...
        <tr>
            ...
            ?>
            <th style=" border: 1px solid black;border-collapse: collapse;text-align: left;"><?php echo e($component->title); ?></th>
        ...
        <tr>
            <td style="border: 1px solid black;border-collapse: collapse;text-align: left;"><?php echo e($order->customer->username); ?></td>
            <td style=" border: 1px solid black;border-collapse: collapse;text-align: left;"><?php echo e($order->id); ?></td>
...
<div style="width: 50%;">
    ...
    <div style="width:100%;">
        <table style="width:50%;  border: 1px solid black;border-collapse: collapse;float:left;">
            ...
            ?>
            <tr>
                <td style="border: 1px solid black;border-collapse: collapse;text-align: left;"><?php echo e($ordersMeal->meals->first()->title); ?></td>
                <td style=" border: 1px solid black;border-collapse: collapse;text-align: left;"><?php echo e($order->id); ?></td>
                <td style="background: #FFFF00; border: 1px solid black;border-collapse: collapse;text-align: left;"><?php echo e($ordersMeal->meals->count()); ?></td>
            </tr>
            <?php } ?>
            ...
            <tr>
                ...
                <td style="  border: 1px solid black;border-collapse: collapse;"><b><?php echo e($mealCount); ?></b></td>
            </tr>
        </table>
        <table style="width:40%;  border: 1px solid black;border-collapse: collapse;float:left;">
            ...
            <tr>
                <td style="  border: 1px solid black;border-collapse: collapse;"><?php echo e($ordersMeal->meals->first()->components->first()->title); ?></td>
                <td style="  border: 1px solid black;border-collapse: collapse;"><?php echo e($sauceCount); ?></td>
            </tr>
            ...
            <tr>
                <td style="  border: 1px solid black;border-collapse: collapse;"></td>
                <td style="  border: 1px solid black;border-collapse: collapse;"><b><?php echo e($sauce[$component->id]); ?></b></td>
            </tr>
        </table>
    </div>
    <table style="width:40%; border: 1px solid black;border-collapse: collapse;float:left; clear:both;margin-top:30px;">
        ...
        ?>
        <tr>
            <td style="  border: 1px solid black;border-collapse: collapse;"><?php echo e($component->title); ?></td>
...
<div style="width: 80%">
    ...
    margin-bottom:30px;">
        ...
        <tr>
            ...
            ?>
            <td style="  border: 1px solid black;border-collapse: collapse;"><?php echo e($ordersMeal->meals->first()->id); ?></td>
        ...
        <tr>
            ...
            ?>
            <th class="verticalTableHeader" style="  border: 1px solid black;border-collapse: collapse;"><p><?php echo e($ordersMeal->meals->first()->title); ?></p>
            </th>
        ...
        <tr>
            ...
            ?>
            <td style=" border: 1px solid black;border-collapse: collapse;"><?php echo e($ordersMeal->meals->count()); ?></td>

            <?php }
            }
            }
            }?>
            <th style="background-color: #28e662; border: 1px solid black;border-collapse: collapse;text-align: left;"><?php echo e($mealCount); ?></th>
        </tr>
        <?php }
        }?>
        <tr>
        ...
        <tr style="background-color: #28e662">
            ...
            <th style=" border: 1px solid black;border-collapse: collapse;text-align: left;"><?php echo e($mealCount); ?></th>
        </tr>
