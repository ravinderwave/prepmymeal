<head>
  ...
  <title>Email Verification || PrepMyMeal</title>
  <style type="text/css">
    #outlook a {padding:0;}
...
<a style="color: #3498DB; text-decoration: none;" href="{{ url('/') }}" target="_blank"><img style="width: 250px; height: 60px; border: 0;" alt="PrepMyMeal" src="{{ asset('assets/frontend/img/preplogo.png') }}">
</a></td>
</tr>
<tr>
<td align="left" style="padding: 0 56px 28px 56px;" valign="top">
<div style="font-family: &quot;lato&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; line-height: 28px;font-size: 20px; color: #333;">Hello {{ ucfirst($username) }},</div>
</td>
</tr>
<tr>
<td align="center" style="padding: 0 56px 28px 56px;" valign="top">
<div style="font-family: &quot;lato&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; line-height: 28px;font-size: 20px; color: #333;"><strong>Account Successfully Created</strong> click the big confirm button to verify your account and start booking your meal.</div>
</td>
</tr>
<tr>
<td align="center" style="padding: 0 56px; padding-bottom: 56px;" valign="top">
<div>
    <a href="{{ route('verifyEmail',$token) }}" style="background-color:#E15718;border-radius:50px;color:#ffffff;display:inline-block;font-family: 'lato', 'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:18px;font-weight: bold;line-height:40px;text-align:center;text-decoration:none;width:270px;-webkit-text-size-adjust:none;" target="_blank">Confirm account now</a>
</div>
</td>
</tr>
</tbody></table>
