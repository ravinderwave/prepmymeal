...
<head>
    ...
    <meta name="description" content="@yield('mdesc')"/>
    <meta name="keywords" content="@yield('mkey')"/>
    <link rel="stylesheet" href="{{ asset('assets/frontend/css/prep.css?v='.rand()) }}">
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    <link rel="stylesheet" href="{{ asset('assets/frontend/css/style.css?v='.rand()) }}"> <!-- Resource style -->
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/frontend/css/heade.css?v='.rand()) }}" media="all"/>
    <script type="text/javascript" src="{{ asset('assets/frontend/js/header_menu.js?v='.rand()) }}"></script>
...
<header class="banner separator-line clear-fix autohide autohide-desktop" id="mainHeader">
    <div class="container">
        ...
        <h1 class='logo no-hover'><span class='sr-only'>prepmymeal</span><a href="{{ url('/') }}"><img
                        src="{{ asset('assets/frontend/img/preplogo.png') }}" alt=""/></a></h1>
        <div class="header-shopping-cart   cd-main-nav__list shopping-icon ">
            <a href="{{ url('/cart') }}" class="cartIco"><i class="fa fa-shopping-cart" aria-hidden="true"></i>
                <span>
                		@if(session()->has('cart'))
                        @php
        ...
        @if(Auth::guard('customer')->check())
            <div class="header-shopping-cart flyout-wrapper js-flyout-wrapper js-shopping-cart-link-wrapper cd-main-nav__list js-signin-modal-trigger">
                <a class="login-menu" href="{{ route('customer.dashboard') }}" data-signin="myaccount"><i class="fa fa-user"></i> My Account</a>
            </div>
            <div class="header-shopping-cart flyout-wrapper js-flyout-wrapper js-shopping-cart-link-wrapper cd-main-nav__list js-signin-modal-trigger">
                <a class="login-menu" href="{{ route('customer.logout') }}" data-signin="login">Logout</a>
            </div>
        @else
            <div class="header-shopping-cart flyout-wrapper js-flyout-wrapper js-shopping-cart-link-wrapper cd-main-nav__list js-signin-modal-trigger">
                <a class="login-menu" href="{{ route('customer.login') }}" data-signin="login">Sign in</a>
            </div>
        @endif
            ...
            <ul class="navigation-main">
                <li class="level0 nav-1 first level-top parent dropdown">
                    ...
                    <ul class="level0 dropdown-menu clearfix" role="menu">
                        <li class="level1 nav-1-3 parent">
                            <ul class="level1">
                                <li class="level2 nav-1-3-1 first"><a href="{{ url('/meals') }}" class=" ee-navigation-link">meals </a></li>
                ...
                <li class="level0 nav-1 first level-top parent">
                    ...
                    <ul class="level0">
                        <li class="level1 nav-1-3 parent">
                            <ul class="level1">
                                <li class="level2 nav-1-3-1 first"><a href="{{ url('/page/info') }}" class="ee-navigation-link">info </a></li>
                                <li class="level2 nav-1-3-1 first"><a href="{{ url('/page/about-us') }}" class=" ee-navigation-link">about us</a></li>
                                <li class="level2 nav-1-3-2"><a href="{{ url('/page/faq') }}" class=" ee-navigation-link">faq</a></li>
                                <li class="level2 nav-1-3-2"><a href="{{ url('/page/blog') }}" class=" ee-navigation-link">blog </a></li>
                            </ul>
                        </li>
                    </ul>
                </li>
...
<footer>
    ...
    <script src="{{ asset('assets/frontend/js/prepmymeal.js?v='.rand()) }}"></script>
    <script type="text/javascript">
        ...
        $('.btnCart').on('click', function (e) {
            ...
            var dataString = {'_token': '{{ csrf_token()}}', mealId: mealId, qty: qty, price: price};
            if (mealId == 'custom') {
                var cmp = $('.cmpChange');
                var cmpArr = [];
                var errMsg = '';
