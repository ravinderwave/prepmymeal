        ...
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner home-slider">
                <div class="item active">
                    <img src="{{ asset('assets/frontend/img/1.jpg') }}" alt="" style="width:100%;">
                    <div class="carousel-caption">
                        <h3 class="banner-text">FOOD DELIVERY</h3>
                    </div>
                </div>
                <div class="item">
                    <img src="{{ asset('assets/frontend/img/2.jpg') }}" alt="" style="width:100%;">
                    <div class="carousel-caption">
                        <h3 class="banner-text">FOOD DELIVERY</h3>
                    </div>
                </div>
                <div class="item">
                    <img src="{{ asset('assets/frontend/img/3.jpg') }}" alt="" style="width:100%;">
                    <div class="carousel-caption">
                        <h3 class="banner-text">FOOD DELIVERY</h3>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="two ">
                ...
                <div class="col-md-3 col-sm-3 col-xs-3  work-img">
                    <img class="img-responsive " src="{{ asset('assets/frontend/img/1_order_your_meals.svg') }}">
                    <div class="work-text">
                ...
                <div class="col-md-3 col-sm-3 col-xs-3 work-img">
                    <img class="img-responsive " src="{{ asset('assets/frontend/img/2.we_cook_fresh.svg') }}">
                    <div class="work-text">
                        <h3 class="work-heading">Lorem Ipsum</h3>
                        <p>Lorem Ipsum is simply dummy text of the printing .</p>
                    </div>
                ...
                <div class="col-md-3 col-sm-3 col-xs-3  work-img">
                    <img class="img-responsive " src="{{ asset('assets/frontend/img/3_deliver.svg') }}">
                    <div class="work-text">
                        <h3 class="work-heading">Lorem Ipsum</h3>
                ...
                <div class="col-md-3 col-sm-3  col-xs-3  work-img">
                    <img class="img-responsive " src="{{ asset('assets/frontend/img/4_eat_enjoy.svg') }}">
                    <div class="work-text">
                        <h3 class="work-heading">Lorem Ipsum</h3>
                        <p>Lorem Ipsum is simply dummy text of the printing .</p>
                    </div>
        ...
        <div class="container">
            <div class="two">
                ...
                <div class="col-md-5 col-sm-12 col-xs-12  meal-product-img">
                    <div class=""><img src="{{ asset('assets/frontend/img/AbnehmBox.png') }}"></div>
                    <div class="translate">
                        <div class=" col-md-6 col-sm-6 col-xs-6">
                            <img id="1imageToSwap" class="profile img-responsive " src="{{ asset('assets/frontend/img/no_item.png') }}">
                        </div>
                        <div class=" col-md-6 col-sm-6 col-xs-6">
                            <img id="2imageToSwap" class="profile img-responsive " src="{{ asset('assets/frontend/img/no_item.png') }}">
                        </div>
                        <div class=" col-md-6 col-sm-6 col-xs-6">
                            <img id="3imageToSwap" class="profile img-responsive " src="{{ asset('assets/frontend/img/no_item.png') }}">
                        </div>
                        <div class=" col-md-6 col-sm-6 col-xs-6">
                            <img id="4imageToSwap" class="profile img-responsive " src="{{ asset('assets/frontend/img/no_item.png') }}">
                        </div>
                    </div>
                </div>
                                                ...
                                                @foreach($components as $component)
                                                    @if($component->type==0)
                                                        <option value="{{ $component->id }}"
                                                                data-img="{{ $component->image }}"
                                                                data-price="{{ $component->price }}"
                                                                data-protein="{{ isset($component->ntr_options_array[0]) && is_numeric($component->ntr_options_array[0]['weight']) ? $component->ntr_options_array[0]['weight'] : 0 }}"
                                                                data-calories="{{ isset($component->ntr_options_array[1]) && is_numeric($component->ntr_options_array[1]['weight']) ? $component->ntr_options_array[1]['weight'] : 0 }}"
                                                                data-carbs="{{ isset($component->ntr_options_array[2]) && is_numeric($component->ntr_options_array[2]['weight']) ? $component->ntr_options_array[2]['weight'] : 0 }}"
                                                                data-fat="{{ isset($component->ntr_options_array[3]) && is_numeric($component->ntr_options_array[3]['weight']) ? $component->ntr_options_array[3]['weight'] : 0 }}"
                ...
                <div class="col-md-12 col-sm-12 col-xs-12  get-started-main">
                    <div class="col-md-4 col-sm-4 col-xs-12  get-started">
                        <a href="muskelaufbau.html">
                            <div class="polaroid">
                                <img src="{{ asset('assets/frontend/img/food-for-muscle.jpg') }}" alt="Norther Lights" style="width:100%">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12  get-started">
                        <a href="{{ url('/meals') }}">
                            <div class="polaroid">
                                <img src="{{ asset('assets/frontend/img/image_1280px_f9e4e4a9e80f4d09ab96d1f627b4b26d.jpeg') }}" alt="Norther Lights"
                                     style="width:100%">
                                <div class="get-startedtext">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12  get-started">
                        <a href="abnehm-box.html">
                            <div class="polaroid">
                                <img src="{{ asset('assets/frontend/img/balance_ejercicio_alimentacion.jpg') }}" alt="Norther Lights"
                                     style="width:100%">
                                <div class="get-startedtext">
        ...
        <div class="container">
            <div class="two ">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12  value-main">
                    <div class="col-md-4 col-sm-4 col-xs-12  get-started">
                        <div class="value-left">
                            <div class="col-md-2 col-sm-3 col-xs-3 food-icon">
                                <img src="{{ asset('assets/frontend/img/food-icon.png') }}" style="width:100%">
                            </div>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12  get-started">
                        <div class="">
                            <img src="{{ asset('assets/frontend/img/1500106271812.png') }}" style="width:100%">
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4 col-xs-12  get-started">
                        <div class="value-left">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12  Calculate-main">
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12 Calculate-main">
                        <div class="calories-result">
                            <img src="{{ asset('assets/frontend/img/calories.jpg') }}">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(document).on('change', '.cmpChange', function () {
                ...
                if (cmpVal != '') {
                    $('#' + cmpNo + 'imageToSwap').attr('src', "{{ asset('uploads') }}/" + cmpImg);
                }
            });
        });
    </script>
